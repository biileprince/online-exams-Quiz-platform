...
exports.ExamsController = exports.storage = void 0;
...
let ExamsController = class ExamsController {
    ...
    update(id, updateExamDto, user) {
        return this.examsService.update(id, updateExamDto, user.id, user.role);
    }
    remove(id, user) {
        return this.examsService.remove(id, user.id, user.role);
    }
    async uploadStudents(examId, file) {
        if (!file)
            throw new common_1.BadRequestException('No Excel file uploaded');
...
__decorate([
    (0, roles_decorator_1.Roles)('ADMIN', 'LECTURER'),
    (0, common_1.Post)(),
...
__decorate([
    (0, roles_decorator_1.Roles)('ADMIN', 'LECTURER'),
    (0, common_1.Post)(':examId/upload-students'),
    (0, common_1.UseInterceptors)((0, platform_express_1.FileInterceptor)('file', { storage: exports.storage })),
    __param(0, (0, common_1.Param)('examId')),
    __param(1, (0, common_1.UploadedFile)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], ExamsController.prototype, "uploadStudents", null);
